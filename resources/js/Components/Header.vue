...
<template>
    ...
    >
        <Link class="hidden sm:inline lg:w-28 size-20 text-center" href="/"
            ><svg
                class="fill-red-500 lg:size-28 size-20"
        ...
        <nav class="mb-5 col-start-1 row-start-2">
            <Link
                href="/news"
