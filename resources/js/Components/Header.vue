...
<template>
    <header class="grid items-center gap-2 pt-10 mb-10 grid-cols-3 border border-3 border-b-red-600 border-l-transparent border-t-transparent border-r-transparent">
        ...
        <nav class="mb-5">
            <Link href="/news" class="mx-2 hover:underline hover:decoration-red-600">News</Link>
            <Link href="/guide" class="mx-2 hover:underline hover:decoration-red-600">Create guide</Link>
        </nav>
    </header>
